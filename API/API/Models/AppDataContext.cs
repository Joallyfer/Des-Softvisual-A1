...
public class AppDataContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlite("Data Source=joallyfer.db");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Chamado>().HasData(
            ...
            new Chamado { ChamadoId = "e5d4a7b9-1f9e-4c4a-ae3b-5b7c1a9d2e3h", Descricao = "Trocar o Mouse", CriadoEm = DateTime.Now.AddDays(2), Status = "Em andamento"}
        );
    }
}
